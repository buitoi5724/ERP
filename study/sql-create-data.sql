...
2 Bảng CATEGORIES thêm dữ liệu :-------------------------------------------------------------------------------------------------
...
(8, 'Seafood', 'Seaweed and fish insect');

SET IDENTITY_INSERT CATEGORY OFF;
3 Dữ liệu Bảng EMPLOYEES -----------------------------------------------------------------------------------------------------------
...
(1, 'Davolio',  'Nancy',   '1968-12-08', 'EmpID1.pic',
 N'Education includes a BA in psychology from Colorado State University. She also completed (The Art of the Cold Call). Nancy is a member of ''Toastmasters International''.'),

(2, 'Fuller',   'Andrew',  '1952-02-19', 'EmpID2.pic',
 N'Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas. He is fluent in French and Italian and reads German. He joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales. Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.'),

(3, 'Leverling','Janet',  '1963-08-30', 'EmpID3.pic',
 N'Janet has a BS degree in chemistry from Boston College). She has also completed a certificate program in food retailing management. Janet was hired as a sales associate and was promoted to sales representative.'),

(4, 'Peacock',  'Margaret','1958-09-19', 'EmpID4.pic',
 N'Margaret holds a BA in English literature from Concordia College and an MA from the American Institute of Culinary Arts. She was temporarily assigned to the London office before returning to her permanent post in Seattle.'),

(5, 'Buchanan', 'Steven', '1955-03-04', 'EmpID5.pic',
 N'Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London, where he was promoted to sales manager. Mr. Buchanan has completed the courses ''Successful Telemarketing'' and ''International Sales Management''. He is fluent in French.'),

(6, 'Suyama',   'Michael','1963-07-02', 'EmpID6.pic',
 N'Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses ''Multi-Cultural Selling'' and ''Time Management for the Sales Professional''. He is fluent in Japanese and can read and write French, Portuguese, and Spanish.'),

(7, 'King',     'Robert', '1960-05-29', 'EmpID7.pic',
 N'Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company. After completing a course entitled ''Selling in Europe'', he was transferred to the London office.'),
...
(9, 'Dodsworth','Anne',  '1969-07-02', 'EmpID9.pic',
 N'Anne has a BA degree in English from St. Lawrence College. She is fluent in French and German.');

SET IDENTITY_INSERT EMPLOYEES OFF;

ALTER TABLE EMPLOYEES
ALTER COLUMN Photo NVARCHAR(255); Đưa dữ liệu của cột Photo về file text
4 Bảng ORDER ---------------------------------------------------------------------------------------------
...
(10725, 21, 4, '1997-10-31', 3),
  (10726, 19, 4, '1997-11-03', 1),
    ...
    (10953, 49, 1, '1998-03-16', 2),
    (10954, 47, 5, '1998-03-17', 1),
    (10955, 24, 8, '1998-03-17', 2),
    (10956, 66, 6, '1998-03-17', 2),
...
('Carnarvon Tigers',7,8,'16 kg pkg.',62.50),
('Teatime Chocolate Biscuits',8,3,'10 boxes x 12 pieces',9.20),
('Sir Rodney''s Marmalade',8,3,'30 gift boxes',81.00),
('Sir Rodney''s Scones',8,3,'24 pkgs. x 4 pieces',10.00),
('Gustaf''s Knäckebröd',9,5,'24 - 500 g pkgs.',21.00),
('Tunnbröd',9,5,'12 - 250 g pkgs.',9.00),
('Guaraná Fantástica',10,1,'12 - 355 ml cans',4.50),
('NuNuCa Nuß-Nougat-Creme',11,3,'20 - 450 g glasses',14.00),
('Gumbär Gummibärchen',11,3,'100 - 250 g bags',31.23),
('Schoggi Schokolade',11,3,'100 - 100 g pieces',43.90),
('Rössle Sauerkraut',12,7,'25 - 825 g cans',45.60),
('Thüringer Rostbratwurst',12,6,'50 bags x 30 sausgs.',123.79),
('Nord-Ost Matjeshering',13,8,'10 - 200 g glasses',25.89),
('Gorgonzola Telino',14,4,'12 - 100 g pkgs',12.50),
('Mascarpone Fabioli',14,4,'24 - 200 g pkgs.',32.00),
('Geitost',15,4,'500 g',2.50),
('Sasquatch Ale',16,1,'24 - 12 oz bottles',14.00),
('Steeleye Stout',16,1,'24 - 12 oz bottles',18.00),
('Inlagd Sill',17,8,'24 - 250 g jars',19.00),
('Gravad lax',17,8,'12 - 500 g pkgs.',26.00),
('Côte de Blaye',18,1,'12 - 75 cl bottles',263.50),
('Chartreuse verte',18,1,'750 cc per bottle',18.00),
('Boston Crab Meat',19,8,'24 - 4 oz tins',18.40),
('Jack''s New England Clam Chowder',19,8,'12 - 12 oz cans',9.65),
('Singaporean Hokkien Fried Mee',20,5,'32 - 1 kg pkgs.',14.00),
('Ipoh Coffee',20,1,'16 - 500 g tins',46.00),
('Gula Malacca',20,2,'20 - 2 kg bags',19.45),
('Røgede sild',21,8,'1k pkg.',9.50),
('Spegesild',21,8,'4 - 450 g glasses',12.00),
('Zaanse koeken',22,3,'10 - 4 oz boxes',9.50),
('Chocolade',22,3,'10 pkgs.',12.75),
('Maxilaku',23,3,'24 - 50 g pkgs.',20.00),
('Valkoinen suklaa',23,3,'12 - 100 g bars',16.25),
('Manjimup Dried Apples',24,7,'50 - 300 g pkgs.',53.00),
('Filo Mix',24,5,'16 - 2 kg boxes',7.00),
('Perth Pasties',24,6,'48 pieces',32.80),
('Tourtière',25,6,'16 pies',7.45),
('Pâté chinois',25,6,'24 boxes x 2 pies',24.00),
('Gnocchi di nonna Alice',26,5,'24 - 250 g pkgs.',38.00),
('Ravioli Angelo',26,5,'24 - 250 g pkgs.',19.50),
('Escargots de Bourgogne',27,8,'24 pieces',13.25),
('Raclette Courdavault',28,4,'5 kg pkg.',55.00),
('Camembert Pierrot',28,4,'15 - 300 g rounds',34.00),
('Sirop d''érable',29,2,'24 - 500 ml bottles',28.50),
('Tarte au sucre',29,3,'48 pies',49.30),
('Vegie-spread',7,2,'15 - 625 g jars',43.90),
('Wimmers gute Semmelknödel',12,5,'20 bags x 4 pieces',33.25),
('Louisiana Fiery Hot Pepper Sauce',2,2,'32 - 8 oz bottles',21.05),
('Louisiana Hot Spiced Okra',2,2,'24 - 8 oz jars',17.00),
('Laughing Lumberjack Lager',16,1,'24 - 12 oz bottles',14.00),
('Scottish Longbreads',8,3,'10 boxes x 8 pieces',12.50),
('Gudbrandsdalsost',15,4,'10 kg pkg.',36.00),
('Outback Lager',7,1,'24 - 355 ml bottles',15.00),
('Fløtemysost',15,4,'10 - 500 g pkgs.',21.50),
('Mozzarella di Giovanni',14,4,'24 - 200 g pkgs.',34.80),
('Röd Kaviar',17,8,'24 - 150 g jars',15.00),
('Longlife Tofu',4,7,'5 kg pkg.',10.00),
('Rhönbräu Klosterbier',12,1,'24 - 0.5 l bottles',7.75),
('Lakkalikööri',23,1,'500 ml',18.00),
('Original Frankfurter grüne Soße',12,2,'12 boxes',13.00);
6 Bảng SHIPERS ---------------------------------------------------------------------------------------------------
INSERT INTO SHIPPERS (ShipperName, Phone) VALUES
('Speedy Express', '(503) 555-9831'),
('United Package', '(503) 555-3199'),
('Federal Shipping', '(503) 555-9931');
6: Dữ liệu  bảng SHIPER ---------------------------------------------------------------------------------------------------
INSERT INTO SHIPPERS (ShipperName, Phone) VALUES
('Speedy Express', '(503) 555-9831'),
('United Package', '(503) 555-3199'),
('Federal Shipping', '(503) 555-9931');
7 : Dữ liệu bảng SUPPERS :----------------------------------------------------------------------------------------------------
...
8 dữ liệu bảng ORDER_DETAILS -----------------------------------------------------------------------
SET IDENTITY_INSERT ORDER_DETAILS ON;

-- Bước 2: Câu lệnh chèn dữ liệu
